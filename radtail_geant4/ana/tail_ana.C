...
void tail_ana(){
  ...
  //TFile *file_G4 = new TFile("../H2_500um_woInRad.root","read");//w/o internal radiation 2020/12/08
  TFile *file_G4 = new TFile("../H2_500um_wInRad.root","read");//w/ internal radiation 2020/12/08
...
//cout<<"labtocm="<<labtocm<<endl;
	...
	h_L->Draw("");
	h_S->Draw("same");
	hmm_L_fom_best->SetLineColor(kRed);
	hmm_L_fom_best->SetFillColor(kRed);
	hmm_L_fom_best->SetFillStyle(3004);
