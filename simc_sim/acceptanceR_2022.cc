...
//K. Okuyama (May  25, 2022) clean for HYP, paper
//bin_mom: 150=>100
...
int main(int argc, char** argv){
	...
	string filename = "RHRS_grnd_large";//0<theta_max<0.1 //2022/6/2
...
//----------------------------//
  ...
  for(int i=0;i<ENum;i++){
	...
	h2_test1->Fill(R_xfp/100.,R_xpfp);//before FP cut
	if(R_xpfp<0.17*R_xfp/100.+0.025&&R_xpfp>0.17*R_xfp/100.-0.035&&R_xpfp<0.40*R_xfp/100.+0.130&&R_xpfp>0.40*R_xfp/100.-0.130){}else{continue;}
	h2_test2->Fill(R_xfp/100.,R_xpfp);//after FP cut
