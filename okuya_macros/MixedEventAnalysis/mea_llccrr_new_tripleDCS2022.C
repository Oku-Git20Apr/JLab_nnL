...
//K. Okuyama (Jun. 05, 2022) RHRS, LHRS acceptance 
//
...
void mea_llccrr_new_tripleDCS2022(){
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
		...
		if(event_selection&&kbinR>=0 &&kbinR<100&&kbinL>=0 &&kbinL<100){
		...
		if((L_tr_vz+R_tr_vz)/2.>=-0.10&&(L_tr_vz+R_tr_vz)/2.<-0.08)LHRS = LHRS_table[kbinL][0];
		else if((L_tr_vz+R_tr_vz)/2.>=-0.08&&(L_tr_vz+R_tr_vz)/2.<-0.06)LHRS = LHRS_table[kbinL][1];
		else if((L_tr_vz+R_tr_vz)/2.>=-0.06&&(L_tr_vz+R_tr_vz)/2.<-0.04)LHRS = LHRS_table[kbinL][2];
		else if((L_tr_vz+R_tr_vz)/2.>=-0.04&&(L_tr_vz+R_tr_vz)/2.<-0.02)LHRS = LHRS_table[kbinL][3];
		else if((L_tr_vz+R_tr_vz)/2.>=-0.02&&(L_tr_vz+R_tr_vz)/2.<0.)LHRS = LHRS_table[kbinL][4];
		else if((L_tr_vz+R_tr_vz)/2.>=0.&&(L_tr_vz+R_tr_vz)/2.<0.02)LHRS = LHRS_table[kbinL][5];
		else if((L_tr_vz+R_tr_vz)/2.>=0.02&&(L_tr_vz+R_tr_vz)/2.<0.04)LHRS = LHRS_table[kbinL][6];
		else if((L_tr_vz+R_tr_vz)/2.>=0.04&&(L_tr_vz+R_tr_vz)/2.<0.06)LHRS = LHRS_table[kbinL][7];
		else if((L_tr_vz+R_tr_vz)/2.>=0.06&&(L_tr_vz+R_tr_vz)/2.<0.08)LHRS = LHRS_table[kbinL][8];
		else if((L_tr_vz+R_tr_vz)/2.>=0.08&&(L_tr_vz+R_tr_vz)/2.<0.10)LHRS = LHRS_table[kbinL][9];
		else cout<<"Z Error"<<(L_tr_vz+R_tr_vz)/2.<<endl;
		...
		//cout<<"mom="<<R_mom<<endl;
		//-------------
		if(LHRS!=0.&&RHRS!=0.&&effDAQ!=0.){
			cs = labtocm/effDAQ/RHRS/LHRS/effK;//[nb/sr/sr]
			cs_lab = 1./effDAQ/RHRS/LHRS/effK;//[nb/sr/sr]
		}else{cs=0.;cs_lab=0.;}
		}else{cs=0.;cs_lab=0.;}
