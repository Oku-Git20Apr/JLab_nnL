...
/*----- -10 < z < -8 -----*/
	string AcceptanceR_table_z0 = "../information/RHRS_SIMC2023_10_z0_phi1.dat";//Acceptance Table (SIMC)
	string buf_z0;
...
/*----- -8 < z < -6 -----*/
	string AcceptanceR_table_z1 = "../information/RHRS_SIMC2023_10_z1_phi1.dat";//Acceptance Table (SIMC)
	string buf_z1;
...
/*----- -6 < z < -4 -----*/
	string AcceptanceR_table_z2 = "../information/RHRS_SIMC2023_10_z2_phi1.dat";//Acceptance Table (SIMC)
	string buf_z2;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -4 < z < -2 -----*/
	string AcceptanceR_table_z3 = "../information/RHRS_SIMC2023_10_z3_phi1.dat";//Acceptance Table (SIMC)
	string buf_z3;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -2 < z < 0 -----*/
	string AcceptanceR_table_z4 = "../information/RHRS_SIMC2023_10_z4_phi1.dat";//Acceptance Table (SIMC)
	string buf_z4;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 0 < z < 2 -----*/
	string AcceptanceR_table_z5 = "../information/RHRS_SIMC2023_10_z5_phi1.dat";//Acceptance Table (SIMC)
	string buf_z5;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z6 = "../information/RHRS_SIMC2023_10_z6_phi1.dat";//Acceptance Table (SIMC)
	string buf_z6;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 4 < z < 6 -----*/
	string AcceptanceR_table_z7 = "../information/RHRS_SIMC2023_10_z7_phi1.dat";//Acceptance Table (SIMC)
	string buf_z7;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z8 = "../information/RHRS_SIMC2023_10_z8_phi1.dat";//Acceptance Table (SIMC)
	string buf_z8;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z9 = "../information/RHRS_SIMC2023_10_z9_phi1.dat";//Acceptance Table (SIMC)
	string buf_z9;
	RHRS_total=0.;
	RHRS_total_bin=0;
