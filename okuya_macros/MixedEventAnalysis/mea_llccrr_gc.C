...
//K. Okuyama (Jan. 22, 2024) elist modified, acc-map: 150bin-->100bin
...
cout << "Output root file name is " << rootname << endl;
  ...
  TFile *file = new TFile("../h2all_2024test.root","read");//input file (default: h2all2.root)
...
//		if(mix_region1==false&&mix_region2==false&&mix_region3==false&&mix_region4==false&&mix_region5==false&&mix_region6==false)cout<<"Weird!"<<endl;
		...
		if(fabs(L_tr_vz-R_tr_vz)<0.025&&fabs(R_tr_vz+L_tr_vz)<0.2&&ac1sum<3.75&&ac2sum>3.&&ac2sum<20.&&R_Tr&&R_FP&&L_Tr&&L_FP&&gcsum>2000.)event_selection=true;
		...
		if(fabs(L_tr_vz-R_tr_vz)<0.025&&fabs(R_tr_vz+L_tr_vz)<0.2&&ac1sum<3.75&&ac2sum>3.&&ac2sum<10.&&R_Tr&&R_FP&&L_Tr&&L_FP&&gcsum>2000.)event_selection_new=true;
		else event_selection_new=false;
		if(fabs(L_tr_vz-R_tr_vz)<0.025&&fabs(R_tr_vz+L_tr_vz)<0.2&&ac1sum<3.75&&ac2sum>3.&&ac2sum<10.&&R_Tr&&R_FP&&L_Tr&&L_FP&&L_mom>2.12&&L_mom<2.18&&R_mom>1.81&&R_mom<1.88&&gcsum>2000.)event_selection_momcut=true;
