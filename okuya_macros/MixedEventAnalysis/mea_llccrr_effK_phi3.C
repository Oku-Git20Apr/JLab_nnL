...
void mea_llccrr_effK_phi3(){
	string pdfname = "temp.pdf";
	string rootname= "bgmea_temp_phi3.root";
...
/*----- -10 < z < -8 -----*/
	string AcceptanceR_table_z0 = "../information/RHRS_SIMC100bin_10_z0_phi3.dat";//Acceptance Table (SIMC)
	string buf_z0;
...
/*----- -8 < z < -6 -----*/
	string AcceptanceR_table_z1 = "../information/RHRS_SIMC100bin_10_z1_phi3.dat";//Acceptance Table (SIMC)
	string buf_z1;
...
/*----- -6 < z < -4 -----*/
	string AcceptanceR_table_z2 = "../information/RHRS_SIMC100bin_10_z2_phi3.dat";//Acceptance Table (SIMC)
	string buf_z2;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -4 < z < -2 -----*/
	string AcceptanceR_table_z3 = "../information/RHRS_SIMC100bin_10_z3_phi3.dat";//Acceptance Table (SIMC)
	string buf_z3;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -2 < z < 0 -----*/
	string AcceptanceR_table_z4 = "../information/RHRS_SIMC100bin_10_z4_phi3.dat";//Acceptance Table (SIMC)
	string buf_z4;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 0 < z < 2 -----*/
	string AcceptanceR_table_z5 = "../information/RHRS_SIMC100bin_10_z5_phi3.dat";//Acceptance Table (SIMC)
	string buf_z5;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z6 = "../information/RHRS_SIMC100bin_10_z6_phi3.dat";//Acceptance Table (SIMC)
	string buf_z6;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 4 < z < 6 -----*/
	string AcceptanceR_table_z7 = "../information/RHRS_SIMC100bin_10_z7_phi3.dat";//Acceptance Table (SIMC)
	string buf_z7;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z8 = "../information/RHRS_SIMC100bin_10_z8_phi3.dat";//Acceptance Table (SIMC)
	string buf_z8;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z9 = "../information/RHRS_SIMC100bin_10_z9_phi3.dat";//Acceptance Table (SIMC)
	string buf_z9;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*-------------------*/
  ...
  TH1F* hmm_mixacc_result_new_phi2_3  = new TH1F("hmm_mixacc_result_new_phi2_3","(tight) |#phi'|<=#pi/3",xbin,xmin,xmax);
//hmm => hcs(Lab) 2020/11/22
  ...
  TH1F* hcs_mixacc_result_new_phi2_3  = new TH1F("hcs_mixacc_result_new_phi2_3","(tight) |#phi'|<=#pi/3",xbin,xmin,xmax);
/*-----------------*/
/*--RESULT OUTPUT--*/
/*-----------------*/
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
	...
	if(abs(phi_k-PI)<=PI/3.)phi2_3_cut=true;
			...
			if(event_selection_new&&phi2_3_cut)hmm_mixacc_result_new_phi2_3->Fill(mm_mixed);
...
//hmm => hcs(Lab) 2020/11/22
			...
			if(event_selection_new&&phi2_3_cut)hcs_mixacc_result_new_phi2_3->Fill(mm_mixed,cs);
//cout<<"mm="<<mm<<endl;
