...
void mea_llccrr_effK_phi2(){
	string pdfname = "temp.pdf";
	string rootname= "bgmea_temp_phi2.root";
...
/*----- -10 < z < -8 -----*/
	string AcceptanceR_table_z0 = "../information/RHRS_SIMC100bin_10_z0_phi2.dat";//Acceptance Table (SIMC)
	string buf_z0;
...
/*----- -8 < z < -6 -----*/
	string AcceptanceR_table_z1 = "../information/RHRS_SIMC100bin_10_z1_phi2.dat";//Acceptance Table (SIMC)
	string buf_z1;
...
/*----- -6 < z < -4 -----*/
	string AcceptanceR_table_z2 = "../information/RHRS_SIMC100bin_10_z2_phi2.dat";//Acceptance Table (SIMC)
	string buf_z2;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -4 < z < -2 -----*/
	string AcceptanceR_table_z3 = "../information/RHRS_SIMC100bin_10_z3_phi2.dat";//Acceptance Table (SIMC)
	string buf_z3;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -2 < z < 0 -----*/
	string AcceptanceR_table_z4 = "../information/RHRS_SIMC100bin_10_z4_phi2.dat";//Acceptance Table (SIMC)
	string buf_z4;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 0 < z < 2 -----*/
	string AcceptanceR_table_z5 = "../information/RHRS_SIMC100bin_10_z5_phi2.dat";//Acceptance Table (SIMC)
	string buf_z5;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z6 = "../information/RHRS_SIMC100bin_10_z6_phi2.dat";//Acceptance Table (SIMC)
	string buf_z6;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 4 < z < 6 -----*/
	string AcceptanceR_table_z7 = "../information/RHRS_SIMC100bin_10_z7_phi2.dat";//Acceptance Table (SIMC)
	string buf_z7;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z8 = "../information/RHRS_SIMC100bin_10_z8_phi2.dat";//Acceptance Table (SIMC)
	string buf_z8;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z9 = "../information/RHRS_SIMC100bin_10_z9_phi2.dat";//Acceptance Table (SIMC)
	string buf_z9;
	RHRS_total=0.;
	RHRS_total_bin=0;
