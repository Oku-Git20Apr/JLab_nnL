...
//hmm => hcs(Lab) 2020/11/22
			if(event_selection&&cm2_angle1_cut)hcs_mixacc_result_cm2_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm2_angle2_cut)hcs_mixacc_result_cm2_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm3_angle1_cut)hcs_mixacc_result_cm3_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm3_angle2_cut)hcs_mixacc_result_cm3_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm3_angle3_cut)hcs_mixacc_result_cm3_3->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm4_angle1_cut)hcs_mixacc_result_cm4_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm4_angle2_cut)hcs_mixacc_result_cm4_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm4_angle3_cut)hcs_mixacc_result_cm4_3->Fill(mm_mixed,cs*labtocm);
			if(event_selection&&cm4_angle4_cut)hcs_mixacc_result_cm4_4->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm2_angle1_cut)hcs_mixacc_result_new_cm2_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm2_angle2_cut)hcs_mixacc_result_new_cm2_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm3_angle1_cut)hcs_mixacc_result_new_cm3_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm3_angle2_cut)hcs_mixacc_result_new_cm3_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm3_angle3_cut)hcs_mixacc_result_new_cm3_3->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm4_angle1_cut)hcs_mixacc_result_new_cm4_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm4_angle2_cut)hcs_mixacc_result_new_cm4_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm4_angle3_cut)hcs_mixacc_result_new_cm4_3->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&cm4_angle4_cut)hcs_mixacc_result_new_cm4_4->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&Qsq2_1_cut)hcs_mixacc_result_new_Qsq2_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&Qsq2_2_cut)hcs_mixacc_result_new_Qsq2_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&Qsq3_1_cut)hcs_mixacc_result_new_Qsq3_1->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&Qsq3_2_cut)hcs_mixacc_result_new_Qsq3_2->Fill(mm_mixed,cs*labtocm);
			if(event_selection_new&&Qsq3_3_cut)hcs_mixacc_result_new_Qsq3_3->Fill(mm_mixed,cs*labtocm);
//cout<<"mm="<<mm<<endl;
