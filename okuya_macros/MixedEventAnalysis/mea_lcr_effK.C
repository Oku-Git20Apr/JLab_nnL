...
//K. Okuyama (Jan. 26, 2023) MEA systematics
...
void mea_lcr_effK(){
	...
	string rootname= "bgmea_temp_lcr.root";
...
/*-----------------*/
 ...
 // tree->Draw(">>elist", "abs(ct_orig+7*2.0)<1.0||abs(ct_orig+2*2.0)<1.0||abs(ct_orig+1.0*2.0)<1.0||abs(ct_orig-4.0*2.0)<1.0||abs(ct_orig-5.0*2.0)<1.0||abs(ct_orig-6.0*2.0)<1.0");
  ...
  tree->Draw(">>elist", "(abs(ct_orig+8.0*2.012)<1.006||abs(ct_orig+2.0*2.012)<1.006||abs(ct_orig-7.0*2.012)<1.006)&&Rp_c>1.760&&Rp_c<1.900&&2.010<Lp_c&&Lp_c<2.160");//2023/1/26
