...
//-- MEA, Choice of Acc. bunches  --//
//----------------------------------//
//
//K. Okuyama (Dec. 30, 2020)//MEA Systematic error
//
//
//
//
//This is taken over from fit_Lexp_strict_aczct.C
...
cout << "Output pdf file name is " << pdfname << endl;
  ...
  TFile *file_mea = new TFile("../MixedEventAnalysis/bgmea_lcr.root","read");//input file of BG(MEA) histo.(default: bgmea6.root)
  ...
  double nbunch = 1500.;//effetive bunches (6 bunches x 1000 mixtures)
...
//change	 fmm_strict_Lexp->SetParLimits(14,0.,1000000.);//scale
	 fmm_strict_Lexp->FixParameter(14,(double)ENum_strict*0.023*0.001);//scale(2%(pion)+0.3%(Al))
	 ...
	 fmm_strict_Lexp->FixParameter(21,0.3/2.);//Al vs Pi
