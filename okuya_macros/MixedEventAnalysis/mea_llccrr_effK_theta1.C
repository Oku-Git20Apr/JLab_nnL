...
void mea_llccrr_effK_theta1(){
	string pdfname = "temp.pdf";
	string rootname= "bgmea_temp_theta1.root";
...
/*----- -10 < z < -8 -----*/
	string AcceptanceR_table_z0 = "../information/RHRS_SIMC2023_10_z0_theta1.dat";//Acceptance Table (SIMC)
	string buf_z0;
