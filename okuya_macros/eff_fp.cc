...
if(i==50){
	...
	bool fpcut=false;
        if( L_tr_th[lt]<0.17*L_tr_x[lt]+0.025
         && L_tr_th[lt]>0.17*L_tr_x[lt]-0.035
         && L_tr_th[lt]<0.40*L_tr_x[lt]+0.130
         && R_tr_th[rt]<0.17*R_tr_x[rt]+0.025
         && R_tr_th[rt]>0.17*R_tr_x[rt]-0.035
         && R_tr_th[rt]<0.40*R_tr_x[rt]+0.130 ) fpcut = true;

		
	if(tr.AC1_npe_sum<3.75 && tr.AC2_npe_sum>3. && tr.AC2_npe_sum<20. && zcut && fpcut){
...
ofstream fout("SR_fp.dat");
cout<<"AC Efficiency is filled."<<endl;
//fout<<n_pi_noZ<<" "<<n_k_noZ<<" "<<n_p_noZ<<" "<<n_L_noZ<<" "<<n_S_noZ<<endl;
		fout<<n_pi[0][0][0]/n_pi_noZ<<" "<<n_k[0][0][0]/n_k_noZ<<" "<<n_p[0][0][0]/n_p_noZ<<" "<<n_L[0][0][0]/n_L_noZ<<" "<<n_S[0][0][0]/n_S_noZ<<" w/FP Cut"<<endl;
//	}
...
c12->cd()->DrawFrame(0.,0.,0.1,1.2);//K,L,S vs th1//Diff
cout<<"c12 start"<<endl;
