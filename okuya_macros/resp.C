...
c1->DrawFrame(-0.1,0.,0.2,300.);
	 f4->SetNpx(20000);
	 f4->SetParameter(0,281);//Lscale
	 //f4->SetParameter(0,0.);
	 f4->SetParameter(1,-0.00064);//mean
	 f4->SetParameter(2,0.00148);//Lsig
	 f4->SetParameter(3,73.29);//Sscale
	 //f4->SetParameter(3,0.);
	 f4->SetParameter(4,0.0766);//Smean
	 f4->SetParameter(5,0.0015);//Ssig
	 //f4->SetParameter(6,0.0766);//scale
	 f4->SetParameter(6,0.);
	 f4->SetParameter(7,0.0324);//att
	 f4->SetParameter(8,0.0235);//sig
	 f4->SetParameter(9,0.0165);//pos
	 //f4->SetParameter(10,0.25);//scale2
	 f4->SetParameter(10,0.);
	 f4->SetParameter(11,0.03);//att2
	 f4->SetParameter(12,0.00116);//sig2
	 f4->SetParameter(13,-0.0698);//pos2
	 //f4->SetParameter(14,0.7097);//scale3
	 f4->SetParameter(14,0.);
	 f4->SetParameter(15,0.00724);//att3
	 f4->SetParameter(16,0.00175);//sig3
	 f4->SetParameter(17,0.00150);//pos3
 f4->Draw("same");
}
