...
void coin_param(){
  ...
  //TFile *file = new TFile("../h2all_Lsingle_1.root","read");//H2_1
  //TFile *file = new TFile("../h2all_Lsingle_2.root","read");//H2_2
  TFile *file = new TFile("../h2all_Lsingle_2_newparam.root","read");//H2_2 (Lambda_H2.param)
