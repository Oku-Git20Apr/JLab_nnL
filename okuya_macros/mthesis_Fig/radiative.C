...
void radiative(){
  ...
  TFile *file_G4 = new TFile("/data/41a/ELS/okuyama/Suzuki_20201208/G4_temp/data/H2_500um_wInRad.root","read");//w/ internal radiation 2020/12/08
...
//cout<<"labtocm="<<labtocm<<endl;
	...
	hmm_simc->Scale(2164./ENum_simc);
	hmm_simc->Scale(220./330.);
