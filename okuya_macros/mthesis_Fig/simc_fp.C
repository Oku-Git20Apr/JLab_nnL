...
//Focal Plane (Feb. 21, 2021)
  ...
  tree_simc->Project("h_R_y_simc","h_yfp","");
  ...
  tree_simc->Project("h_L_ph_simc","h_ypfp","");
  ...
  tree_simc->Project("h_L_tg_th_simc","h_xptar","");
  ...
  tree_simc->Project("h_L_tg_ph_simc","h_yptar","");
