...
//  TH1F* hmm_bg_fom_best  = new TH1F("hmm_bg_fom_best","hmm_bg_fom_best",xbin,xmin,xmax);
  ...
  TH1F* h_zave  = new TH1F("h_zave","",1000,-25.,25.);
...
//	Al_contami_dummy/=0.0003;
	...
	h_zave->GetXaxis()->SetTitle("Z-vertex [cm]");
	h_zave->GetYaxis()->SetTitle("Counts");
	//h_zave_dummy->Draw("");
...
//	fz_back->Draw("same");
	...
	h_den->GetXaxis()->SetTitle("X [cm]");
	h_den->GetYaxis()->SetTitle("H_{2} Survival Ratio");
	h_num->GetXaxis()->SetTitle("X [cm]");
	h_num->GetYaxis()->SetTitle("H_{2} Survival Ratio");
	h_den2->GetXaxis()->SetTitle("X [cm]");
	h_den2->GetYaxis()->SetTitle("Al Contamination Ratio");
	h_num2->GetXaxis()->SetTitle("X [cm]");
	h_num2->GetYaxis()->SetTitle("Al Contamination Ratio");
	double den2, num2;
	...
	TH1D* hf10 = (TH1D*)c10->DrawFrame(0.,0.,25.,1.1);
	hf10->GetXaxis()->SetTitle("X [cm]");
	hf10->GetYaxis()->SetTitle("H_{2} Survival Ratio");
	hf10->GetYaxis()->SetDecimals();
	hf10->Draw("");
	pEff1->Draw("same");

	TCanvas* c11 = new TCanvas("c11","c11",800,800);
	TH1D* hf11 = (TH1D*)c11->DrawFrame(0.,0.,25.,1.0);
	hf11->GetXaxis()->SetTitle("X [cm]");
	hf11->GetYaxis()->SetTitle("Al Contamination Ratio");
	hf11->GetYaxis()->SetDecimals();
	hf11->Draw("");
	//pEff1->Draw("");
...
//	h_zz_dummy->Draw("colz");
	...
	c9->Print("./pdf/Al_fit.pdf");
	c10->Print("./pdf/Al_gasSR.pdf");
	c11->Print("./pdf/Al_contami.pdf");
