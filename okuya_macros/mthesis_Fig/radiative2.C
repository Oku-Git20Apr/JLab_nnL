...
void radiative2(){
  ...
  TFile *file_mea = new TFile("/data/41a/ELS/okuyama/JLab_nnL/okuya_macros/MixedEventAnalysis/bgmea_mthesis_2020Nov.root","read");//w/o internal radiation 2020/12/08
...
//cout<<"labtocm="<<labtocm<<endl;
	...
	TH1F* hmm_bg_temp = (TH1F*)file_mea->Get("hmm_mixed");
	for(int i=0;i<300;i++){
