...
cout << " output file name is " << ofname << endl;
   ...
   tr->Add("~/nnL_root_41a/tritium_111157_1.root");//or runlist
   tr->Add("~/nnL_root_41a/tritium_111157_2.root");
   tr->Add("~/nnL_root_41a/tritium_111157_3.root");
   tr->Add("~/nnL_root_41a/tritium_111157_4.root");
   tr->Add("~/nnL_root_41a/tritium_111157.root");
