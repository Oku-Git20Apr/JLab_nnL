...
cout << "Output pdf file name is " << pdfname << endl;
  ...
  TFile *file = new TFile("../h2all_noCalib.root","read");//input file of all H2 run
  //TFile *file = new TFile("../h2all_2021Mar.root","read");//input file of all H2 run(w/o Itabashi matrix, w/ SIMC initial matrix)
  ...
  //TFile *file_simc = new TFile("/data/41a/ELS/okuyama/SIMC_jlab/SIMC/rootfiles/BOTH_LS_20cm_cell_x10.root","read");// L:S0=3:1 (0.9M vs 0.3M) 2020/12/10
...
cout << "Print is starting" << endl;
	...
	c64->Print("SIMC_vs_noCalib.pdf[");
	c64->Print("SIMC_vs_noCalib.pdf");
	c70->Print("SIMC_vs_noCalib.pdf");
	c71->Print("SIMC_vs_noCalib.pdf");
	c72->Print("SIMC_vs_noCalib.pdf");
	c73->Print("SIMC_vs_noCalib.pdf");
	c80->Print("SIMC_vs_noCalib.pdf");
	c81->Print("SIMC_vs_noCalib.pdf");
	c90->Print("SIMC_vs_noCalib.pdf");
	c91->Print("SIMC_vs_noCalib.pdf");
	c92->Print("SIMC_vs_noCalib.pdf");
	c93->Print("SIMC_vs_noCalib.pdf");
	c94->Print("SIMC_vs_noCalib.pdf");
	c95->Print("SIMC_vs_noCalib.pdf");
	c95->Print("SIMC_vs_noCalib.pdf]");
