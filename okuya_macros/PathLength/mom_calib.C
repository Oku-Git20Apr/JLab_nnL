...
cout<<proton_par1[i]<<endl;
	...
	cout<<"fpi_line->GetParameter(0)="<<fpi_line->GetParameter(0)<<endl;
	cout<<"fp_line->GetParameter(0)="<<fp_line->GetParameter(0)<<endl;
	cout<<"fpi_line->GetParameter(0)-fp_line->GetParameter(0)"<<fpi_line->GetParameter(0)-fp_line->GetParameter(0)<<endl;
	cout<<"fpi_line->GetParameter(1)="<<fpi_line->GetParameter(1)<<endl;
	cout<<"fp_line->GetParameter(1)="<<fp_line->GetParameter(1)<<endl;
	cout<<"fpi_line->GetParameter(1)-fp_line->GetParameter(1)"<<fpi_line->GetParameter(1)-fp_line->GetParameter(1)<<endl;
	//f1_path->Draw("");
	//h_path_mom->Draw("esame");
