...
//change
  ...
  TFile *file_mea = new TFile("./MixedEventAnalysis/bgmea_llccrr_new_2022effK_theta2.root","read");// 2023/10/6 Mom cut & effK in cs & 4.313 GeV & nmix750
...
/*----- -10 < z < -8 -----*/
	string AcceptanceR_table_z0 = "./information/RHRS_SIMC2023_10_z0_theta2.dat";//Acceptance Table (SIMC) //change
	string buf_z0;
...
/*----- -8 < z < -6 -----*/
	string AcceptanceR_table_z1 = "./information/RHRS_SIMC2023_10_z1_theta2.dat";//Acceptance Table (SIMC)
	string buf_z1;
...
/*----- -6 < z < -4 -----*/
	string AcceptanceR_table_z2 = "./information/RHRS_SIMC2023_10_z2_theta2.dat";//Acceptance Table (SIMC)
	string buf_z2;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -4 < z < -2 -----*/
	string AcceptanceR_table_z3 = "./information/RHRS_SIMC2023_10_z3_theta2.dat";//Acceptance Table (SIMC)
	string buf_z3;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -2 < z < 0 -----*/
	string AcceptanceR_table_z4 = "./information/RHRS_SIMC2023_10_z4_theta2.dat";//Acceptance Table (SIMC)
	string buf_z4;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 0 < z < 2 -----*/
	string AcceptanceR_table_z5 = "./information/RHRS_SIMC2023_10_z5_theta2.dat";//Acceptance Table (SIMC)
	string buf_z5;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z6 = "./information/RHRS_SIMC2023_10_z6_theta2.dat";//Acceptance Table (SIMC)
	string buf_z6;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 4 < z < 6 -----*/
	string AcceptanceR_table_z7 = "./information/RHRS_SIMC2023_10_z7_theta2.dat";//Acceptance Table (SIMC)
	string buf_z7;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 6 < z < 8 -----*/
	string AcceptanceR_table_z8 = "./information/RHRS_SIMC2023_10_z8_theta2.dat";//Acceptance Table (SIMC)
	string buf_z8;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 8 < z < 10 -----*/
	string AcceptanceR_table_z9 = "./information/RHRS_SIMC2023_10_z9_theta2.dat";//Acceptance Table (SIMC)
	string buf_z9;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
//Analysis Part: fitting and fitting...
	...
	TH1F* hmm_bg_fom_strict=(TH1F*)file_mea->Get("hmm_mixacc_result_new_cm2_2");//change//cm2_1,cm2_2
	TH1F* hcs_bg_fom_strict=(TH1F*)file_mea->Get("hcs_mixacc_result_new_cm2_2");//change 
...
//change ENum???
	 ...
	 //fmm_strict_Lexp->FixParameter(14,(double)ENum_strict_cs_cm2_2*0.021*0.001);//scale(1.8%(pion)+0.3%(Al)) //B.G. ratio
	 fmm_strict_Lexp->FixParameter(15,Al_par1);//mean
	 fmm_strict_Lexp->FixParameter(16,Al_par2);//Gsigma
	 fmm_strict_Lexp->FixParameter(17,Al_par3);//Lfwhm
	 fmm_strict_Lexp->FixParameter(18,pion_par1);//mean
