...
//Mom-Z
  ...
  tree_simc->Project("h_L_z_mom_simc","zposi:Lp_rec","");
  ...
  tree_simc->Project("h_R_z_mom_simc","zposi:Rp_rec","");
...
cout << "Print is starting" << endl;
	...
	c10->Print("20230921.pdf[");
	c10->Print("20230921.pdf[");//pepk simc
	c20->Print("20230921.pdf");//pepk data
	c30->Print("20230921.pdf");//pepk same
	c50->Print("20230921.pdf");//FP 1D
	c51->Print("20230921.pdf");//FP 1D
	//c60->Print("20230921.pdf");//FPxtar 2D
	//c61->Print("20230921.pdf");//FPxtar 2D
	c64->Print("20230921.pdf");//FP vs Mom. 2D
	c70->Print("20230921.pdf");//FP 2D
	c71->Print("20230921.pdf");//FP 2D
	c72->Print("20230921.pdf");//FP 2D
	c73->Print("20230921.pdf");//FP 2D
	c80->Print("20230921.pdf");//tar 2D
	c81->Print("20230921.pdf");//tar 2D
	c90->Print("20230921.pdf");//FPxtar 2D
	c91->Print("20230921.pdf");//FPxtar 2D
	c92->Print("20230921.pdf");//FPxtar 2D
	c93->Print("20230921.pdf");//FPxtar 2D
	c94->Print("20230921.pdf");//FPxtar 2D
	c95->Print("20230921.pdf");//FPxtar 2D
	c95->Print("20230921.pdf]");//FPxtar 2D
