...
//cout<<"labtocm="<<labtocm<<endl;
		...
		double xx = sin(theta_gk_lab)*cos(phi_k);
		double yy = sin(theta_gk_lab)*sin(phi_k);
		double zz = cos(theta_gk_lab);
		double xx_cm = sin(theta_gk_cm)*cos(phi_k);
		double yy_cm = sin(theta_gk_cm)*sin(phi_k);
