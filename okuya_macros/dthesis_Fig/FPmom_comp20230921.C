...
c201->Print("20230921_FPcut1.pdf");//L w/ FP cut
c202->Print("20230921_FPcut2.pdf");//L w/ FP,Mom cut
c203->Print("20230921_FPcut3.pdf");//R w/ FP cut
c204->Print("20230921_FPcut4.pdf");//R w/ FP,Mom cut
cout << "Well done!" << endl;
}//fit
