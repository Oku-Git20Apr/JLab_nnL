...
//  TH1F* hmm_bg_fom_best  = new TH1F("hmm_bg_fom_best","hmm_bg_fom_best",xbin,xmin,xmax);
  ...
  TH2F* gklab_gkcm = new TH2F("gklab_gkcm","X'_{gk}^{lab} vs X'_{gk}^{CM}",100,0.,0.15,100,0.,0.4);
  TH2F* gklab_eklab = new TH2F("gklab_eklab","X'_{gk}^{lab} vs X'_{ek}^{lab}",100,0.,0.15,100,0.15,0.3);
  TH2F* eelab_eklab = new TH2F("eelab_eklab","X'_{ee}^{lab} vs X'_{ek}^{lab}",100,0.15,0.3,100,0.15,0.3);
  TH2F* eklab_gkcm = new TH2F("eklab_gkcm","X'_{gk}^{CM} vs X'_{ek}^{lab}",100,0.,0.4,100,0.15,0.3);
  TH2F* ekcm_gkcm = new TH2F("ekcm_gkcm","X'_{gk}^{CM} vs X'_{ek}^{CM}",100,0.,0.25,100,0.15,0.4);
  TH2F* cos_gklab_gkcm = new TH2F("cos_gklab_gkcm","X'_{gk}^{lab} vs X'_{gk}^{CM}",100,0.98,1.0,100,0.92,1.0);
  TH2F* cos_gklab_eklab = new TH2F("cos_gklab_eklab","X'_{gk}^{lab} vs X'_{ek}^{lab}",100,0.98,1.0,100,0.95,1.0);
  TH2F* cos_eelab_eklab = new TH2F("cos_eelab_eklab","X'_{ee}^{lab} vs X'_{ek}^{lab}",100,0.95,1.0,100,0.95,1.0);
  TH2F* cos_eklab_gkcm = new TH2F("cos_eklab_gkcm","X'_{gk}^{CM} vs X'_{ek}^{lab}",100,0.95,1.0,100,0.95,1.0);
  TH2F* cos_ekcm_gkcm = new TH2F("cos_ekcm_gkcm","X'_{gk}^{CM} vs X'_{ek}^{CM}",100,0.9,1.0,100,0.9,1.0);
  ...
  TH2F* h_xth_L  = new TH2F("h_xth_L","LHRS: FP X vs FP X'",100,-80.,80.,100,-0.16,0.16);
  TH2F* h_xth_L_cut  = new TH2F("h_xth_L_cut","LHRS: FP X vs FP X' (w/ cut)",100,-80.,80.,100,-0.16,0.16);
  TH2F* h_xth_L_mom  = new TH2F("h_xth_L_mom","LHRS: FP X vs FP X' (w/ mom)",100,-80.,80.,100,-0.16,0.16);
  TH2F* h_xth_R  = new TH2F("h_xth_R","RHRS: FP X vs FP X'",100,-80.,80.,100,-0.16,0.16);
  TH2F* h_xth_R_cut  = new TH2F("h_xth_R_cut","RHRS: FP X vs FP X' (w/ cut)",100,-80.,80.,100,-0.16,0.16);
  TH2F* h_xth_R_mom  = new TH2F("h_xth_R_mom","RHRS: FP X vs FP X' (w/ mom)",100,-80.,80.,100,-0.12,0.16);
  TH1F* h_chi2_L  = new TH1F("h_chi2_L","LHRS: #chi^{2}",1000,0.,0.01);
  TH1F* h_chi2_R  = new TH1F("h_chi2_R","RHRS: #chi^{2}",1000,0.,0.01);
  SetTH2(h_xth_L, "", "X(FP) [cm]", "X'(FP) [rad]", 0.4);
  SetTH2(h_xth_R, "", "X(FP) [cm]", "X'(FP) [rad]", 0.4);
  SetTH2(h_xth_L_cut, "", "X(FP) [cm]", "X'(FP) [rad]", 0.4);
  SetTH2(h_xth_R_cut, "", "X(FP) [cm]", "X'(FP) [rad]", 0.4);
  SetTH2(h_xth_L_mom, "", "X(FP) [cm]", "X'(FP) [rad]", 0.4);
  SetTH2(h_xth_R_mom, "", "X(FP) [cm]", "X'(FP) [rad]", 0.4);
...
cout<<"Entries: "<<ENum<<endl;
	chain->Project("h_xth_L","L.tr.th:L.tr.x*100.","DL.evtype==5","");
	chain->Project("h_xth_L_cut","L.tr.th:L.tr.x*100.","DL.evtype==5&&L.tr.th<0.17*L.tr.x+0.025 && L.tr.th>0.17*L.tr.x-0.035 && L.tr.th<0.40*L.tr.x+0.130","");
	//chain->Project("h_xth_L_mom","L.tr.th:L.tr.x","DL.evtype==5&&L.tr.th<0.17*L.tr.x+0.025 && L.tr.th>0.17*L.tr.x-0.035 && L.tr.th<0.40*L.tr.x+0.130&&Rp_c>1.760&&Rp_c<1.900&&Lp_c>2.010&&Lp_c<2.160","");
	chain->Project("h_xth_R","R.tr.th:R.tr.x*100.","DR.evtype==5","");
	chain->Project("h_xth_R_cut","R.tr.th:R.tr.x*100.","DR.evtype==5&&R.tr.th<0.17*R.tr.x+0.025 && R.tr.th>0.17*R.tr.x-0.035 && R.tr.th<0.40*R.tr.x+0.130","");
	//chain->Project("h_xth_R_mom","R.tr.th:R.tr.x","DR.evtype==5&&R.tr.th<0.17*R.tr.x+0.025 && R.tr.th>0.17*R.tr.x-0.035 && R.tr.th<0.40*R.tr.x+0.130&&Rp_c>1.760&&Rp_c<1.900&&Lp_c>2.010&&Lp_c<2.160","");
	...
	h_xth_L->GetYaxis()->SetDecimals(2);
	h_xth_L->GetXaxis()->SetDecimals(2);
	h_xth_L->Draw("colz");
	...
	h_xth_L_cut->GetYaxis()->SetDecimals(2);
	h_xth_L_cut->GetXaxis()->SetDecimals(2);
	...
	//h_xth_L_mom->Draw("colz");
	//c22->SetLeftMargin(0.14);
	//c22->SetRightMargin(0.14);
	//c22->SetTopMargin(0.14);
	//c22->SetBottomMargin(0.14);
	//c22->Modified();
	//c22->Update();
	//gPad->Modified();
	//gPad->Update();
	TCanvas* c3 = new TCanvas("c3","c3", 800., 800.);
	h_xth_R->GetYaxis()->SetDecimals(2);
	h_xth_R->GetXaxis()->SetDecimals(2);
	h_xth_R->Draw("colz");
	...
	h_xth_R_cut->GetYaxis()->SetDecimals(2);
	h_xth_R_cut->GetXaxis()->SetDecimals(2);
	...
	//h_xth_R_mom->Draw("colz");
	//c44->SetLeftMargin(0.14);
	//c44->SetRightMargin(0.14);
	//c44->SetTopMargin(0.14);
	//c44->SetBottomMargin(0.14);
	//c44->Modified();
	//c44->Update();
	//gPad->Modified();
	//gPad->Update();
...
c1->Print("FP_1.pdf");//L w/o FP cut
c2->Print("FP_2.pdf");//L w/  FP cut
c3->Print("FP_3.pdf");//R w/o FP cut
c4->Print("FP_4.pdf");//R w/  FP cut
