//--  Cointime vs MM   --//
//
//K. Okuyama (Oct. 27, 2020)
//
//This is taken over from test_out.C
...
//h_ct2->Draw("");
hmm_ctout2->Draw("");
TF1 *fmm_L=new TF1("fmm_L","gausn",-0.1,0.1);
TF1 *fmm_bg=new TF1("fmm_bg","pol1",-0.1,0.1);
hmm_ctout2->Fit("fmm_L","","",-0.002,0.002);
hmm_ctout2->Fit("fmm_bg","","",-0.03,-0.01);
fmm_L->SetLineStyle(1);
fmm_bg->SetLineStyle(1);
fmm_L->Draw("same");
fmm_bg->Draw("same");
	cout<<"fmm_L"<<fmm_L->Integral(-0.006,0.006)*1000.;
	cout<<"fmm_bg"<<fmm_bg->Integral(-0.002,0.002)*1000.;
