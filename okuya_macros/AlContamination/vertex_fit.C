...
//	 //fS_best->Draw("same");
	...
	c7->SetLogy(1);
	 ...
	 TF1* fz_corr  = new TF1("fz_corr","F_VZ2",-0.25,0.25,11);
...
//par[9]: pol2 coeff.2
//par[10]: total scale 
    fz_corr->SetParameter(0,5600.);
    fz_corr->SetParameter(1,-0.125);
    fz_corr->SetParameter(2,0.003);
    fz_corr->SetParameter(3,0.07);
    fz_corr->SetParameter(4,-0.002);
    fz_corr->SetParameter(5,0.007);
    fz_corr->SetParameter(6,4000.);
    fz_corr->SetParameter(7,0.125);
    fz_corr->SetParameter(8,-25.);
    fz_corr->SetParameter(9,-0.01);
    fz_corr->SetParameter(10,2.5);
