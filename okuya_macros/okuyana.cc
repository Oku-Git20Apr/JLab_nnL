...
extern double calcf2t_3rd(double* P, double xf, double xpf, 
...
void okuyana::matrix(string mtparam){
...
void okuyana::Calib(int rt, int lt ){
...
////////////////////////////////////////////////////////////////////////////
void okuyana::SetRoot(string ifname){
  add_tree(ifname);
  pack_tree();
  readtreeHRSR();
  readtreeHRSL();
...
/////////////////////////////
void okuyana::SetRunList(string ifname){
...
double okuyana::CoinCalc_c(int RS2_seg, int LS2_seg, int rhit, int lhit){
...
void okuyana::PathCalib(int rhit, int lhit){
...
double okuyana::Eloss(double yp,double z,char* arm){
...
void okuyana::Loop(){
  ...
  for(int n=0;n<ENum;n++){
    ...
    tr.LS2T_F1[SEG]=-9999.;
    tr.LS2B_F1[SEG]=-9999.;
    tr.RS2T_F1_c[SEG]=-9999.;
    tr.RS2B_F1_c[SEG]=-9999.;
    tr.LS2T_F1_c[SEG]=-9999.;
    tr.LS2B_F1_c[SEG]=-9999.;
    tr.RS2T_F1_b[SEG]=-9999.;
    tr.RS2B_F1_b[SEG]=-9999.;
    tr.LS2T_F1_b[SEG]=-9999.;
    tr.LS2B_F1_b[SEG]=-9999.;         
    }
...
/* +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+ */
void okuyana::ReadParam(string name){
...
/* +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+ */
void okuyana::Swich(bool nnL, bool scale){
...
int main(int argc, char** argv){
  ...
  string mtparam;
  string root_init="../rootfiles/mmass/okuyana/";
...
double okuyana::BG_Al(int events){
...
double okuyana::AC_npe(int nac, int seg, double adc){
