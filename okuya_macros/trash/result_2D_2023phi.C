...
cout << "Output pdf file name is " << pdfname << endl;
  ...
  TFile *file_mea = new TFile("./MixedEventAnalysis/bgmea_llccrr_new_2022effK_phi1.root","read");// 2022/1/30 Mom cut & effK in cs
...
/*----- -10 < z < -8 -----*/
	string AcceptanceR_table_z0 = "./information/RHRS_SIMC100bin_10_z0_phi1.dat";//Acceptance Table (SIMC)
	string buf_z0;
...
/*----- -8 < z < -6 -----*/
	string AcceptanceR_table_z1 = "./information/RHRS_SIMC100bin_10_z1_phi1.dat";//Acceptance Table (SIMC)
	string buf_z1;
...
/*----- -6 < z < -4 -----*/
	string AcceptanceR_table_z2 = "./information/RHRS_SIMC100bin_10_z2_phi1.dat";//Acceptance Table (SIMC)
	string buf_z2;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -4 < z < -2 -----*/
	string AcceptanceR_table_z3 = "./information/RHRS_SIMC100bin_10_z3_phi1.dat";//Acceptance Table (SIMC)
	string buf_z3;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- -2 < z < 0 -----*/
	string AcceptanceR_table_z4 = "./information/RHRS_SIMC100bin_10_z4_phi1.dat";//Acceptance Table (SIMC)
	string buf_z4;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 0 < z < 2 -----*/
	string AcceptanceR_table_z5 = "./information/RHRS_SIMC100bin_10_z5_phi1.dat";//Acceptance Table (SIMC)
	string buf_z5;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 2 < z < 4 -----*/
	string AcceptanceR_table_z6 = "./information/RHRS_SIMC100bin_10_z6_phi1.dat";//Acceptance Table (SIMC)
	string buf_z6;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 4 < z < 6 -----*/
	string AcceptanceR_table_z7 = "./information/RHRS_SIMC100bin_10_z7_phi1.dat";//Acceptance Table (SIMC)
	string buf_z7;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 6 < z < 8 -----*/
	string AcceptanceR_table_z8 = "./information/RHRS_SIMC100bin_10_z8_phi1.dat";//Acceptance Table (SIMC)
	string buf_z8;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
/*----- 8 < z < 10 -----*/
	string AcceptanceR_table_z9 = "./information/RHRS_SIMC100bin_10_z9_phi1.dat";//Acceptance Table (SIMC)
	string buf_z9;
	RHRS_total=0.;
	RHRS_total_bin=0;
...
//change
		if(abs(phi_k-PI)<=PI/4.&&ct_cut==true){ct_cut=true;}
		//if(abs(phi_k-PI)>PI/4.&&abs(phi_k-PI)<=PI/2.&&ct_cut==true){ct_cut=true;}
		else{ct_cut=false;}
...
//Analysis Part: fitting and fitting...
	...
	TH1F* hmm_bg_fom_strict=(TH1F*)file_mea->Get("hmm_mixacc_result_new_phi2_1");//change
	TH1F* hcs_bg_fom_strict=(TH1F*)file_mea->Get("hcs_mixacc_result_new_phi2_1");//change
