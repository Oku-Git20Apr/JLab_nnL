...
//// Gas Cherenkov ////
  double L_cer_a[LCL], L_cer_a_c[LCL], L_cer_a_p[LCL];                    // ADC, decADC, ADC(ped-supp)
  double L_cer_t[LCL], L_cer_t_c[LCL];                                    // TDC, decTDC
  double L_cer_asum_p, L_cer_asum_c;                                      // sumADC(ped-supp), sum-decADC
  double L_cer_trpath[MAX], L_cer_trx[MAX], L_cer_try[MAX];               // track path length, track x-pos, track y-pos
  double L_cer_nhits[LCL], L_cer_peak[LCL];                               // Hits, FADC peak val
  double L_cer_t_fadc[LCL], L_cer_tc_fadc[LCL];                           // FADC TDC, FADC decTDC
  double L_cer_nbadped[LCL], L_cer_nunderflow[LCL], L_cer_noverflow[LCL]; // ped-quality, underflow, overflow bit

//// Pre-shower ////
  double L_ps_a[LCL], L_ps_a_c[LCL], L_ps_a_p[LCL];                     // ADC, decADC, ADC(ped-supp)
  double L_ps_t[LCL], L_ps_t_c[LCL];                                    // TDC, decTDC
  double L_ps_asum_p, L_ps_asum_c;                                      // sumADC(ped-supp), sum-decADC

//// Shower ////
  double L_sh_a[LCL], L_sh_a_c[LCL], L_sh_a_p[LCL];                     // ADC, decADC, ADC(ped-supp)
  double L_sh_t[LCL], L_sh_t_c[LCL];                                    // TDC, decTDC
  double L_sh_asum_p, L_sh_asum_c;                                      // sumADC(ped-supp), sum-decADC
...
//// Tracking ////
  ...
  double RS2T_F1_b[RS2],RS2B_F1_b[RS2];
