  ...
  for(int i=0;i<ENum;i++){
    ...
    if(i%time_div==0){
      ...
      cout<<i<<" / "<<ENum<<" ("<<i*100/ENum<<"%) : "<<Form("%.0lf sec passed,  %.0lf sec left",diff,esttime)<<endl;
		...
		if(ac1sum>3.75&&ac2sum>10.)ac_cut=true;//pion dominant
		//if(ac1sum<3.75&&ac2sum<2.)ac_cut=true;//proton dominant
		//if(ac1sum<3.75&&ac2sum>3.&&ac2sum<10.&&fabs(L_tr_vz-R_tr_vz)<0.025&&fabs(R_tr_vz+L_tr_vz)<0.2)ac_cut=true;
...
//	 hcoin_wobg->Fit("fcoin_first","","",2.,4.);
...
//
////Accidentals Fitting
//	 TF1 *fcoin=new TF1("fcoin",fcoin_total,-20.,100.,17);
//	 fcoin->SetNpx(20000);
//	 fcoin->SetParameter(0,600.);//acc
//	 fcoin->SetParameter(1,0.);//
//	 fcoin->SetParLimits(1,-1.,1.);//
//	 fcoin->SetParameter(2,fcoin_first->GetParameter(2));//G Fix
//	 //fcoin->SetParLimits(2,0.,0.6);//
//	 fcoin->FixParameter(3,fcoin_first->GetParameter(3));//L fix
...
//	 fcoin->FixParameter(8,0.);//k
////	 fcoin->FixParameter(9,0.);//k
////	 fcoin->FixParameter(10,fcoin_first->GetParameter(2));
////	 fcoin->FixParameter(11,fcoin_first->GetParameter(3));
//	 fcoin->FixParameter(12,0.);//p
////	 fcoin->SetParameter(13,-8.);//p
////	 fcoin->FixParameter(14,fcoin_first->GetParameter(2));
////	 fcoin->FixParameter(15,fcoin_first->GetParameter(3));
//	 fcoin->SetParameter(16,2.012);
...
//	 fcoin->SetParameter(14,gsigma);//p G Fix
//	 fcoin->SetParLimits(14,0.,2.);
//	 fcoin->FixParameter(15,lwidth);//p L Fix
...
//	 fcoin_pi->SetParameter(0,fcoin->GetParameter(4));
//	 fcoin_pi->SetParameter(1,fcoin->GetParameter(5));
//	 fcoin_pi->SetParameter(2,fcoin->GetParameter(6));
//	 fcoin_pi->SetParameter(3,fcoin->GetParameter(7));
//	 fcoin_k->SetParameter(0,fcoin->GetParameter(8));
//	 fcoin_k->SetParameter(1,fcoin->GetParameter(9));
//	 fcoin_k->SetParameter(2,fcoin->GetParameter(10));
//	 fcoin_k->SetParameter(3,fcoin->GetParameter(11));
...
//	 fcoin_p->SetParameter(3,fcoin->GetParameter(15));
////
