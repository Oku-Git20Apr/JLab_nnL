...
//	hmm_mea_pion->Scale(1/21.54/2.);
	...
	hmm_mea_comparison->SetLineColor(kViolet);
	...
	hmm_mea_comparison_lr->Draw("same");
	hmm_mea_comparison_cl->Draw("same");
	hmm_mea_comparison_cr->Draw("same");
