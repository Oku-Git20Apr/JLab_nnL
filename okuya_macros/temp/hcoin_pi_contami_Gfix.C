...
//Global Fitting
	 ...
	 double ksigma=fcoin->GetParameter(10);
	 fcoin->FixParameter(0,area);
	 fcoin->FixParameter(1,location);
	 fcoin->FixParameter(2,gsigma);
	 fcoin->FixParameter(3,lwidth);
...
//G	 fcoin->SetParLimits(6,0.,0.5);
	 ...
	 fcoin->SetParameter(8,karea);//k
	 fcoin->SetParLimits(8,0.,500.);//k
	 fcoin->FixParameter(9,klocation);
	 fcoin->FixParameter(10,ksigma);
...
//G	 fcoin->SetParLimits(14,0.,2.);
	 //fcoin->FixParameter(15,lwidth);//p L Fix
	 fcoin->SetParLimits(15,0.,2.);
