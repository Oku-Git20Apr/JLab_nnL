...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
//%%2022. 6. 15. ver., HYP2022		%//
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
	x_result[0]=8.;//deg
	y_result[0]=0.426;//ub/sr
	xe_result[0]=8.;
	xel_result[0]=8.;
	xeh_result[0]=8.;
	ye_result[0]=0.022;//Stat.
	yel_result[0]=0.0613;//Stat. & Syst. low
	yeh_result[0]=0.0432;//Stat. & Syst. up
	x2_result[0]=4.;//deg
	y2_result[0]=0.421;//ub/sr
	xe2_result[0]=4.;//deg
	ye2_result[0]=0.024;//ub/sr
	xel2_result[0]=4.;
	xeh2_result[0]=4.;
	yel2_result[0]=0.0629;
	yeh2_result[0]=0.0691;
	x2_result[1]=12.;//deg
	y2_result[1]=0.438;//ub/sr
	xe2_result[1]=4.;
	ye2_result[1]=0.025;//ub/sr
	xel2_result[1]=4.;
	xeh2_result[1]=4.;
	yel2_result[1]=0.0687;
	yeh2_result[1]=0.0725;
...
//c1->Print("/data/41a/ELS/okuyama/JLab_nnL/okuya_macros/mthesis_Fig/pdf/symp_gpKL.pdf");
}
