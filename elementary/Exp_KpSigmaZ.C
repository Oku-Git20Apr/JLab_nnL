...
0.041
  ...
  leg->AddEntry(gr7     ,"LEPS #scale[0.6]{PRC73(2006) 035214}    #scale[0.5]{(#sqrt{s}=2.163 GeV)}","pl");
  leg->AddEntry(gr5     ,"MAID #scale[0.6]{PRC61(1999) 012201.}   #scale[0.5]{(#sqrt{s}=2.110 GeV)}","pl");
  leg->AddEntry(gr6     ,"SLA #scale[0.6]{PRC58(1998) 75.}          #scale[0.5]{(#sqrt{s}=2.110 GeV)}","pl");
	...
	x_result[0]=8.;//deg
	y_result[0]=0.045181;//ub/sr
	xe_result[0]=8.;
	ye_result[0]=0.003;
	x2_result[0]=4.;//deg
	y2_result[0]=0.038352;//ub/sr
	xe2_result[0]=4.;
	ye2_result[0]=0.006;
	x2_result[1]=12.;//deg
	y2_result[1]=0.052151;//ub/sr
	xe2_result[1]=4.;
	ye2_result[1]=0.006;
	x3_result[0]=3.;//deg
	y3_result[0]=0.030292;//ub/sr
	xe3_result[0]=3.;
	ye3_result[0]=0.01;
	x3_result[1]=8.;//deg
	y3_result[1]=0.051121;//ub/sr
	xe3_result[1]=2.;
	ye3_result[1]=0.01;
	x3_result[2]=13.;//deg
	y3_result[2]=0.052488;//ub/sr
	xe3_result[2]=3.;
	ye3_result[2]=0.01;
  ...
  gr5->Draw("Lsame");
  gr6->Draw("Lsame");
TBox *b = new TBox(0.,0.042,16.,0.048); 
	b->SetFillColor(2); 
	b->SetFillStyle(0);
	b->SetLineColor(2);
	b->SetLineWidth(1);
TBox *b2_1 = new TBox(0.,0.0377,8.,0.0443); 
	b2_1->SetFillColor(3); 
	b2_1->SetFillStyle(0);
	b2_1->SetLineColor(3);
	b2_1->SetLineWidth(1);
TBox *b2_2 = new TBox(8.,0.046,16.,0.058); 
	b2_2->SetFillColor(3); 
	b2_2->SetFillStyle(0);
	b2_2->SetLineColor(3);
	b2_2->SetLineWidth(1);
TBox *b3_1 = new TBox(0.,0.02,6.,0.04); 
	b3_1->SetFillColor(4); 
	b3_1->SetFillStyle(0);
	b3_1->SetLineColor(4);
	b3_1->SetLineWidth(1);
TBox *b3_2 = new TBox(6.,0.041,10.,0.061); 
	b3_2->SetFillColor(4); 
	b3_2->SetFillStyle(0);
	b3_2->SetLineColor(4);
	b3_2->SetLineWidth(1);
TBox *b3_3 = new TBox(10.,0.042,16.,0.062); 
	b3_3->SetFillColor(4); 
	b3_3->SetFillStyle(0);
	b3_3->SetLineColor(4);
	b3_3->SetLineWidth(1);
