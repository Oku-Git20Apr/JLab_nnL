...
0.041
  ...
  TLegend *leg = new TLegend(0.5,0.7,0.98,0.98,"","NDC");
  leg->SetFillColor(0);
  ...
  leg->SetMargin(0.15);
  leg->SetNColumns(1);
  leg->AddEntry(gr1     ,Form("SAPHIR #scale[0.7]{EPJA19(2004) 251.}"
  ...
  leg->AddEntry(gr4     ,Form("CLAS #scale[0.7]{PRC82(2010) 025202.}"
                        ,dataset4->GetKinematics()->GetW()/1000.),"pl");
  //leg->AddEntry(gr7     ,"LEPS #scale[0.6]{PRC73(2006) 035214}    #scale[0.5]{(#sqrt{s}=2.163 GeV)}","pl");
  leg->AddEntry(gr5     ,"KM #scale[0.7]{PRC61(1999) 012201.}","pl");
  leg->AddEntry(gr6     ,"SLA #scale[0.7]{PRC58(1998) 75.}","pl");
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
  ...
  //TGraph *gr_result = new TGraph(1, x_result, y_result);
  TGraphErrors *gr_result = new TGraphErrors(1, x_result, y_result, xe_result, ye_result);
  gr_result->SetMarkerSize(1.5);
  gr_result->SetMarkerStyle(21);
  //gr_result->SetFillStyle(3004);
  ...
  //TGraph *gr2_result = new TGraph(2, x2_result, y2_result);
  TGraphErrors *gr2_result = new TGraphErrors(2, x2_result, y2_result, xe2_result, ye2_result);
  gr2_result->SetMarkerSize(1.5);
  gr2_result->SetMarkerStyle(21);
  //gr2_result->SetFillStyle(3005);
...
c1->Print("/data/41a/ELS/okuyama/JLab_nnL/okuya_macros/mthesis_Fig/pdf/abst_CS_thetadepS.pdf");
}
