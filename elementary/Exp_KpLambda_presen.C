...
void all_pdf(){
  ...
  TH2F *h2 = new TH2F("h2","h2",1000,-1,1,1000,0,0.5);//change scale
  h2->SetStats(kFALSE);
  SetTH2(h2,"","","",0.020,10);
  TGraph *gr[200];
...
void draw_KpLambda(){
  ...
  TH2F *h2 = new TH2F("h2","h2",1000,0.,180.,1000,0,0.5);//change scale
  h2->SetStats(kFALSE);
...
0.066
  ...
  TGaxis *ay = new TGaxis(0,0, 0,0.5, 0,0.5, 505 );//change scale
