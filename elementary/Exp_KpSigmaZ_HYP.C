...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
	...
	x2_result[0]=4.;//deg
	y2_result[0]=0.0584;//ub/sr
	xe2_result[0]=4.;
	xel2_result[0]=4.;
	xeh2_result[0]=4.;
	ye2_result[0]=0.006;//Stat.
	yel2_result[0]=0.0135;//Stat. & Syst.
	yeh2_result[0]=0.0565;//Stat. & Syst.

	x2_result[1]=12.;//deg
	y2_result[1]=0.0813;//ub/sr
	xe2_result[1]=4.;
	xel2_result[1]=4.;
	xeh2_result[1]=4.;
	ye2_result[1]=0.007;
	yel2_result[1]=0.0171;
	yeh2_result[1]=0.0769;
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
